...
const URL_api ="http://localhost:5164/getallSubsciber";
const DELETE_API ='http://localhost:5164/delete_subscribers'
const Subscribers = () => {
  ...
  return (
    ...
    <div id="content">
        ...
        <div className="container-fluid">
              ...
              <h2 className='headingsame'>SUBSCRIBERS</h2>
