...
const URL_api = 'http://localhost:5164/getAllInformation';
const DELETE_API = '';
const Information = () => {
  ...
  <div id="content">
        ...
        <div className="container-fluid">
              <div className='searchbar'>
                 <h2 className='headingsame'>INFORMATIONS</h2>
              </div>  
          </div>
        </nav>
        <div className="container-fluid">
                ...
                <React.Fragment key={index}>
                  {item.map((value, idx) => (
                    <tr style={{ cursor: 'pointer' }} key={idx}>
                      ...
                      <td>{value[6]}</td>
                      <td>{value[7]}</td> 
                      <td><Button variant="danger" onClick={() => handleDelete(value[0])}>Delete</Button></td>
                    </tr>
                  ))}
                </React.Fragment>
              ))}
