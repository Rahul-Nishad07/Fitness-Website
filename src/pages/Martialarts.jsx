...
const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post('http://localhost:5164/martial', payload);
...
<div className="col-md-8">
  <div className="single-popular-post">
    ...
    <p>Bodybuilding involves weightlifting and nutrition to increase muscle size, strength, and definition, often for aesthetic purposes or competitive bodybuilding events.  
    </p>
    <div className="description-box">
      <h3 className="sub-title">Description</h3>
    ...
    <div className="work-benifits">
      <h3 className="sub-title">Workout benefits</h3>
      <ul>
        <li><i className="fa fa-angle-right" />  Bodybuilding enhances cardiovascular health, reducing the risk of heart disease.
        .</li>
        <li><i className="fa fa-angle-right" />  Mental well-being improves with stress reduction and increased confidence

        </li>
        <li><i className="fa fa-angle-right" />     Boosted metabolism aids weight management and promotes fat loss.
        .</li>
